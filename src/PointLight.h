...
struct PointLight
{
  public:
    ...
    // Set Functions
    //----------------
    void SetAttributes(glm::vec3 newAmbient = glm::vec3(0.2f), glm::vec3 newAlbedo = glm::vec3(1.0, 0.75, 0.5),
        glm::vec3 newSpecular = glm::vec3(1.0f), float newConstant = 1.0f, float newLinear = 0.09f, float newQuadratic = 0.032f)
    {
