...
void MaterialComponentPanel::OnRender(std::shared_ptr<ResourceHub> resHub, MaterialComponent &component,
...
MaterialComponentPanel::DragAndDropTexture(std::shared_ptr<ResourceHub> resHub, MaterialComponent &component) {
