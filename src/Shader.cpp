...
Shader::Shader(std::string name) { this->name = name; }

Shader::Shader(std::string dir, void* args) { Create(dir, dir.c_str(), (const char*)args, nullptr); }
...
unsigned int Shader::GetID() { return shader_ID; }